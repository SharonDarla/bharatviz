...
const CITY_DATASETS: CityDataset[] = [
  ...
  // --- LivingAtlas/ramSeraph cities ---
  { id: 'la_agartala', displayName: 'Agartala', state: 'Tripura', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 102, geojsonPath: '/cities/la_agartala.geojson' },
  { id: 'la_aizawl', displayName: 'Aizawl', state: 'Mizoram', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 19, geojsonPath: '/cities/la_aizawl.geojson' },
  { id: 'la_amravati', displayName: 'Amravati', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 33, geojsonPath: '/cities/la_amravati.geojson' },
  { id: 'la_arrah', displayName: 'Arrah', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 45, geojsonPath: '/cities/la_arrah.geojson' },
  { id: 'la_basti', displayName: 'Basti', state: 'Uttar Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 25, geojsonPath: '/cities/la_basti.geojson' },
  { id: 'la_bhagalpur', displayName: 'Bhagalpur', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 51, geojsonPath: '/cities/la_bhagalpur.geojson' },
  { id: 'la_bihar_sharif', displayName: 'Bihar Sharif', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 46, geojsonPath: '/cities/la_bihar_sharif.geojson' },
  { id: 'la_bijnor', displayName: 'Bijnor', state: 'Uttar Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 32, geojsonPath: '/cities/la_bijnor.geojson' },
  { id: 'la_bulandshahr', displayName: 'Bulandshahr', state: 'Uttar Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 37, geojsonPath: '/cities/la_bulandshahr.geojson' },
  { id: 'la_chapra', displayName: 'Chapra', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 44, geojsonPath: '/cities/la_chapra.geojson' },
  { id: 'la_chengalpattu', displayName: 'Chengalpattu', state: 'Tamil Nadu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 33, geojsonPath: '/cities/la_chengalpattu.geojson' },
  { id: 'la_damoh', displayName: 'Damoh', state: 'Madhya Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 39, geojsonPath: '/cities/la_damoh.geojson' },
  { id: 'la_davanagere', displayName: 'Davanagere', state: 'Karnataka', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 45, geojsonPath: '/cities/la_davanagere.geojson' },
  { id: 'la_deoghar', displayName: 'Deoghar', state: 'Jharkhand', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 36, geojsonPath: '/cities/la_deoghar.geojson' },
  { id: 'la_dharamshala', displayName: 'Dharamshala', state: 'Himachal Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 17, geojsonPath: '/cities/la_dharamshala.geojson' },
  { id: 'la_diamond_harbour', displayName: 'Diamond Harbour', state: 'West Bengal', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 16, geojsonPath: '/cities/la_diamond_harbour.geojson' },
  { id: 'la_dindigul', displayName: 'Dindigul', state: 'Tamil Nadu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 48, geojsonPath: '/cities/la_dindigul.geojson' },
  { id: 'la_diu', displayName: 'Diu', state: 'Daman & Diu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 13, geojsonPath: '/cities/la_diu.geojson' },
  { id: 'la_gangtok', displayName: 'Gangtok', state: 'Sikkim', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 19, geojsonPath: '/cities/la_gangtok.geojson' },
  { id: 'la_ghazipur', displayName: 'Ghazipur', state: 'Uttar Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 25, geojsonPath: '/cities/la_ghazipur.geojson' },
  { id: 'la_haridwar', displayName: 'Haridwar', state: 'Uttarakhand', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 60, geojsonPath: '/cities/la_haridwar.geojson' },
  { id: 'la_hosur', displayName: 'Hosur', state: 'Tamil Nadu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 45, geojsonPath: '/cities/la_hosur.geojson' },
  { id: 'la_imphal', displayName: 'Imphal', state: 'Manipur', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 28, geojsonPath: '/cities/la_imphal.geojson' },
  { id: 'la_itanagar', displayName: 'Itanagar', state: 'Arunachal Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 20, geojsonPath: '/cities/la_itanagar.geojson' },
  { id: 'la_jagdalpur', displayName: 'Jagdalpur', state: 'Chhattisgarh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 48, geojsonPath: '/cities/la_jagdalpur.geojson' },
  { id: 'la_jalna', displayName: 'Jalna', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 31, geojsonPath: '/cities/la_jalna.geojson' },
  { id: 'la_jind', displayName: 'Jind', state: 'Haryana', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 31, geojsonPath: '/cities/la_jind.geojson' },
  { id: 'la_kaithal', displayName: 'Kaithal', state: 'Haryana', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 31, geojsonPath: '/cities/la_kaithal.geojson' },
  { id: 'la_kalaburagi', displayName: 'Kalaburagi', state: 'Karnataka', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 58, geojsonPath: '/cities/la_kalaburagi.geojson' },
  { id: 'la_kanchipuram', displayName: 'Kanchipuram', state: 'Tamil Nadu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 51, geojsonPath: '/cities/la_kanchipuram.geojson' },
  { id: 'la_karur', displayName: 'Karur', state: 'Tamil Nadu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 48, geojsonPath: '/cities/la_karur.geojson' },
  { id: 'la_kohima', displayName: 'Kohima', state: 'Nagaland', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 19, geojsonPath: '/cities/la_kohima.geojson' },
  { id: 'la_kolhapur', displayName: 'Kolhapur', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 81, geojsonPath: '/cities/la_kolhapur.geojson' },
  { id: 'la_leh', displayName: 'Leh', state: 'Ladakh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 13, geojsonPath: '/cities/la_leh.geojson' },
  { id: 'la_moirang', displayName: 'Moirang', state: 'Manipur', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 12, geojsonPath: '/cities/la_moirang.geojson' },
  { id: 'la_murwara', displayName: 'Murwara', state: 'Madhya Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 45, geojsonPath: '/cities/la_murwara.geojson' },
  { id: 'la_muzaffarpur', displayName: 'Muzaffarpur', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 49, geojsonPath: '/cities/la_muzaffarpur.geojson' },
  { id: 'la_nanded_waghala', displayName: 'Nanded-Waghala', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 31, geojsonPath: '/cities/la_nanded_waghala.geojson' },
  { id: 'la_nashik', displayName: 'Nashik', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 44, geojsonPath: '/cities/la_nashik.geojson' },
  { id: 'la_pali', displayName: 'Pali', state: 'Rajasthan', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 65, geojsonPath: '/cities/la_pali.geojson' },
  { id: 'la_palwal', displayName: 'Palwal', state: 'Haryana', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 31, geojsonPath: '/cities/la_palwal.geojson' },
  { id: 'la_panaji', displayName: 'Panaji', state: 'Goa', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 30, geojsonPath: '/cities/la_panaji.geojson' },
  { id: 'la_panchkula', displayName: 'Panchkula', state: 'Haryana', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 20, geojsonPath: '/cities/la_panchkula.geojson' },
  { id: 'la_port_blair', displayName: 'Port Blair', state: 'Andaman & Nicobar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 24, geojsonPath: '/cities/la_port_blair.geojson' },
  { id: 'la_puducherry', displayName: 'Puducherry', state: 'Puducherry', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 33, geojsonPath: '/cities/la_puducherry.geojson' },
  { id: 'la_puri', displayName: 'Puri', state: 'Odisha', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 32, geojsonPath: '/cities/la_puri.geojson' },
  { id: 'la_ratlam', displayName: 'Ratlam', state: 'Madhya Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 49, geojsonPath: '/cities/la_ratlam.geojson' },
  { id: 'la_rewari', displayName: 'Rewari', state: 'Haryana', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 31, geojsonPath: '/cities/la_rewari.geojson' },
  { id: 'la_roorkee', displayName: 'Roorkee', state: 'Uttarakhand', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 20, geojsonPath: '/cities/la_roorkee.geojson' },
  { id: 'la_rudrapur', displayName: 'Rudrapur', state: 'Uttarakhand', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 20, geojsonPath: '/cities/la_rudrapur.geojson' },
  { id: 'la_sagar', displayName: 'Sagar', state: 'Madhya Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 51, geojsonPath: '/cities/la_sagar.geojson' },
  { id: 'la_sangli', displayName: 'Sangli', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 69, geojsonPath: '/cities/la_sangli.geojson' },
  { id: 'la_sasaram', displayName: 'Sasaram', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 40, geojsonPath: '/cities/la_sasaram.geojson' },
  { id: 'la_satara', displayName: 'Satara', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 20, geojsonPath: '/cities/la_satara.geojson' },
  { id: 'la_satna', displayName: 'Satna', state: 'Madhya Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 46, geojsonPath: '/cities/la_satna.geojson' },
  { id: 'la_shillong', displayName: 'Shillong', state: 'Meghalaya', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 27, geojsonPath: '/cities/la_shillong.geojson' },
  { id: 'la_shivamogga', displayName: 'Shivamogga', state: 'Karnataka', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 35, geojsonPath: '/cities/la_shivamogga.geojson' },
  { id: 'la_silchar', displayName: 'Silchar', state: 'Assam', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 42, geojsonPath: '/cities/la_silchar.geojson' },
  { id: 'la_silvassa', displayName: 'Silvassa', state: 'Dadra Nagar Haveli', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 15, geojsonPath: '/cities/la_silvassa.geojson' },
  { id: 'la_siwan', displayName: 'Siwan', state: 'Bihar', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 38, geojsonPath: '/cities/la_siwan.geojson' },
  { id: 'la_solapur', displayName: 'Solapur', state: 'Maharashtra', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 38, geojsonPath: '/cities/la_solapur.geojson' },
  { id: 'la_sonipat', displayName: 'Sonipat', state: 'Haryana', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 20, geojsonPath: '/cities/la_sonipat.geojson' },
  { id: 'la_thanjavur', displayName: 'Thanjavur', state: 'Tamil Nadu', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 102, geojsonPath: '/cities/la_thanjavur.geojson' },
  { id: 'la_thoubal', displayName: 'Thoubal', state: 'Manipur', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 18, geojsonPath: '/cities/la_thoubal.geojson' },
  { id: 'la_tinsukia', displayName: 'Tinsukia', state: 'Assam', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 15, geojsonPath: '/cities/la_tinsukia.geojson' },
  { id: 'la_tumakuru', displayName: 'Tumakuru', state: 'Karnataka', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 35, geojsonPath: '/cities/la_tumakuru.geojson' },
  { id: 'la_vizianagaram', displayName: 'Vizianagaram', state: 'Andhra Pradesh', type: 'wards', source: 'LivingAtlas/ramSeraph', label: 'Wards', featureCount: 60, geojsonPath: '/cities/la_vizianagaram.geojson' },
].map(ds => ({
  ...ds,
